...
export const siteDescription = 'Computer science and business administration at USC. Projects, built end-to-end.'
export const siteBio = 'Computer science and business administration at USC. Los Angeles.'
export const links = {
