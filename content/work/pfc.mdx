...
<Figure
  n={1}
  src="/work/pfc/today.png"
  width={2880}
  height={1620}
  alt="PFC's Today screen: the card closest to its utilization line, a meter against the 30% reporting line, a second card well under it, freshness for accounts and figures, and the next gated actions"
  caption="Today. The card closest to its line leads, measured at statement close rather than the due date, and every figure says whether it was observed from a feed or derived from the ledger."
  source="The Today screen, with invented accounts and amounts."
/>
...
<Figure
  n={2}
  src="/work/pfc/plan.png"
  width={2880}
  height={1280}
  alt="PFC's Plan screen: the Chase 5/24 count derived from self-opened tradelines with their roll-off dates, and hard inquiries counted separately per bureau"
  caption="Plan. 5/24 is derived from the tradelines you opened yourself, each with its roll-off date; authorized-user lines are shown and excluded. Inquiries are counted per bureau and never merged."
  source="The Plan screen, with invented accounts and dates."
/>
...
<Figure
  n={4}
  src="/work/pfc/forward.png"
  width={2880}
  height={1720}
  alt="PFC's Forward screen: cash left over in the leanest projected year against a year of living costs, and the order of claim on that year's wages"
  caption="Forward. The projection runs from the declared assumptions and leads with the leanest year, not the first. Each claim on that year's wages is listed in the order it is taken."
  source="The Forward screen, with invented amounts."
/>
...
As of the public docs: 1,400+ commits since 6 August 2026, 37 migrations, 285 test files, 3,144 unit tests and 352 Playwright checks across four viewports.
