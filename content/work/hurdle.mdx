export const meta = {
  ...
  source: 'Private by design, no git remote. Engineering docs public as PFC.',
  links: [
...
Hurdle holds the full state of my finances, checks every action against the plan's gates before it happens, and ranks every dollar's next-best use in one queue. The engineering docs are public under the project's working name, PFC. The source and the ledger never leave the machine.
