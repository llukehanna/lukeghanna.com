export const meta = {
  ...
  source: 'Public. MIT.',
  links: [
    { label: 'Live site', handle: 'clippers.lukeghanna.com', href: 'https://clippers.lukeghanna.com' },
