export const meta = {
  title: 'Shedquarters',
  line: 'A skill-rating ladder for a house league, scored from a phone at the table.',
  ...
  glance: [
    ...
    { label: 'Tests', value: '561 across 39 files' },
  ],
}
...
<Figure
  ...
  source="Recorded from the real app against a local database of made-up players."
/>
...
<Figure
  ...
  source="Screenshot of the app against a local database of made-up players."
/>
